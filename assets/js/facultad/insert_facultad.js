$('#agregar_facultades').click(function() {
    ...
    if (
        ...
        insertar_facultades(activo, codigo, nombre, telefono, email, personacontacto, personatelefono, personaemail)
    }

});

function insertar_facultades(activo, codigo, nombre, telefono, email, personacontacto, personatelefono, personaemail) {
    $.ajax({
        dataType: 'json',
        url: baseurl + 'facultades/insertar',
        type: 'post',
        dataType: 'json',
        data: {
            activo,

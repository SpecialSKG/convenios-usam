...
<div class="container mx-0 px-0 ">
    <div class="container d-flex d-flex justify-content-between mt-5">
        ...
        <div class="row">
            ...
            <label class="switch col">
                <input type="checkbox" disabled name="activo" id="activo">
    ...
    <div class="row mt-5">
        ...
        <div class="col-10">
            ...
            <input type="text" disabled name="codigo" id="codigo" class="form-control rounded-pill" value="<?= $item->codigo ?>" />
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-2">
        ...
        <div class="col-10">
            <input type="text" disabled name="nombre" id="nombre" class="form-control rounded-pill" value="<?= $item->nombre ?>" />
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-2">
        ...
        <div class="col-10">
            <input type="text" disabled name="telefono" id="telefono" class="form-control rounded-pill" value="<?= $item->telefono ?>" />
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-2">
        ...
        <div class="col-10">
            <input type="email" disabled name="email" id="email" class="form-control rounded-pill" value="<?= $item->email ?>" />
        </div>
    </div>
    ...
    <div class="ml-5">
        <div class="row mt-3">
            ...
            <div class="col-10">
                <input type="text" disabled name="personacontacto" id="personacontacto" class="form-control rounded-pill" value="<?= $item->personacontacto ?>" />
            </div>
        </div>
        <div class="row mt-3">
            <div class="col-2">
            ...
            <div class="col-10">
                <input type="text" disabled name="personatelefono" id="personatelefono" class="form-control rounded-pill" value="<?= $item->personatelefono ?>" />
            </div>
        </div>
        <div class="row mt-3">
            <div class="col-2">
            ...
            <div class="col-10">
                <input type="email" disabled name="personaemail" id="personaemail" class="form-control rounded-pill" value="<?= $item->personaemail ?>" />
            </div>
        </div>
        <div class="container d-flex justify-content-center mt-4 mb-4 ">
            <?php if ($this->session->userdata('rol_') == 1 || $this->session->userdata('rol_') == 2) { ?>
                <a type="submit" href="<?= base_url() . 'oficinas/Modificar/' . $item->codigo ?>" class="btn btn-lg btn-usam">Actualizar Entidad</a>
            <?php } ?>

...
<form method="post" action="insertarconvenio" class="mt-0 pt-0 pb-5" enctype="multipart/form-data">
    ...
    <div class="row pt-5">
        <div class="d-flex flex-wrap col-12">
            ...
            <input class="col-md-10 col-sm-12 form-control rounded-pill" type="text" name="nombre" id="nombre" required='true'>
        </div>
    </div>
    ...
    <div class="row pt-5">
        <div class="d-flex flex-wrap col-12">
            ...
            <input class="col-md-10 col-sm-12 form-control rounded-pill" type="text" name="obj" id="obj" required='true'>
        </div>
    </div>
    ...
    <div class="row pt-5">
        <div class="d-flex flex-wrap col-12">
            ...
            <div class="d-flex flex-wrap col-md-2 col-sm-4">
                ...
                <div class="btn btn-success" id="eliminarTodaEntidad" name="eliminarTodaEntidad"><i class="fas fa-folder-minus"></i></div>
            </div>
        </div>
    </div>

    <div class="row pt-3 ml-5" id="entidadesLista" name="entidadesLista">
    ...
    <div class="row pt-5">
        <div class="d-flex col-12 flex-wrap">
            ...
            <div class="d-flex flex-wrap col-md-2 col-sm-4">
                ...
                <div class="btn btn-success" id="eliminarTodaFacultad" name="eliminarTodaFacultad"><i class="fas fa-folder-minus"></i></div>
            </div>
        </div>
    </div>

    <div class="row pt-3 ml-5" id="FacultadLista" name="FacultadLista">
    ...
    <div class="row pt-5">
        <div class="d-flex col-12 flex-wrap">
            ...
            <div class="d-flex flex-wrap col-md-2 col-sm-4">
                ...
                <div class="btn btn-success" id="eliminarTodaOficina" name="eliminarTodaOficina"><i class="fas fa-folder-minus"></i></div>
            </div>
        </div>
    </div>

    <div class="row pt-3 ml-5" id="oficinaLista" name="oficinaLista">
    ...
    <div class="row pt-5">
        <div class="d-flex flex-wrap col-12">
            ...
            <input class="col-sm-12 col-md-10 form-control rounded-pill" type="date" name="fechainicio" id="fechainicio" required='true'>
        </div>
    </div>
    ...
    <div class="row pt-5">
        <div class="d-flex flex-wrap col-12">
            ...
            <input class="col-ms-12 col-md-10 form-control rounded-pill" type="date" name="fechafinalizar" id="fechafinalizar" required='true'>
        </div>
    </div>
    ...
    <div class="row pt-5">
        <div class="d-flex flex-wrap col-12">
            ...
            <textarea class="col-ms-12 col-md-10 form-control rounded" type="text" name="observaciones" id="observaciones" required='true' rows="4" cols="50">
